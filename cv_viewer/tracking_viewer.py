...
def get_image_position(bounding_box_image):
...
def render_2D(left_display, objects, is_tracking_on):
    ...
    for obj in objects.object_list:
        if(render_object(obj, is_tracking_on)):
            ...
            top_left_corner = cvt(obj.bounding_box_2d[0])
            top_right_corner = cvt(obj.bounding_box_2d[1])
            bottom_right_corner = cvt(obj.bounding_box_2d[2])
            bottom_left_corner = cvt(obj.bounding_box_2d[3])
            ...
            position_image = get_image_position(obj.bounding_box_2d)
